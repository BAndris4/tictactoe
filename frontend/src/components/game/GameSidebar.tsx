  ...
  return (
    <div className="w-full md:w-80 flex flex-col gap-4 py-2 min-h-0">
      ...
      {!isLocalGame && onResign && (
        <button 
          onClick={onResign}
          className="flex items-center justify-center gap-2 bg-white/80 hover:bg-white text-coral px-6 py-4 rounded-2xl font-bold shadow-sm transition-all hover:scale-[1.01] active:scale-95 border border-white flex-shrink-0"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
